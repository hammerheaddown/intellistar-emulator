...
const MORNING = [{name: "Now", subpages: [{name: "current-page", duration: 10000}]},{name: "Today", subpages: [{name: "today-page", duration: 12000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 12000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 10000}, {name: "7day-page", duration: 16000}]},]
const NIGHT = [{name: "Now", subpages: [{name: "current-page", duration: 10000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 12000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 10000}, {name: "tomorrow-night-page", duration: 10000}, {name: "7day-page", duration: 16000}]},]
const SINGLE = [{name: "Alert", subpages: [{name: "single-alert-page", duration: 8000}]},{name: "Now", subpages: [{name: "current-page", duration: 10000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 12000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 10000}, {name: "7day-page", duration: 16000}]},]
const MULTIPLE = [{name: "Alerts", subpages: [{name: "multiple-alerts-page", duration: 8000}]},{name: "Now", subpages: [{name: "current-page", duration: 10000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 12000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 10000}, {name: "7day-page", duration: 16000}]},]
